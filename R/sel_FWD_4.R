#############################################################################
## Sequential & parallel robust forward greedy search REDDA: in this case the trimming units are the same for both grouping and no grouping models, i.e., those units trimmed for the grouping model
#############################################################################
